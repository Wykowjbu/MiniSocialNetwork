...
namespace MiniSocialNetwork.Pages.Users
{
    public class FollowingModel : PageModel
    {
        ...
        public FollowingModel(IProfileService profileService, IFollowService followService)
        {
        ...
        public IEnumerable<FollowViewModel>? Following { get; set; }
        ...
        public async Task<IActionResult> OnGetAsync(string username)
        {
            ...
            Following = await _followService.GetFollowingAsync(profile.UserId, CurrentUserId);
            return Page();
        }
        ...
        public async Task<IActionResult> OnPostToggleFollowAsync(int targetUserId)
        {
            ...
            return RedirectToPage("/Users/Following", new { username = Username });
        }
    }
}
